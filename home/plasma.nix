# generated and tweaked plasma config
{ ... }:
{
  programs.plasma = {
    enable = true;
    ...
    shortcuts = {
      "ActivityManager"."switch-to-activity-4e05a776-1eca-4a3e-97fe-0e848bd4ff1a" = [ ];
    ...
    configFile = {
      ...
      "dolphinrc"."ExtractDialog"."DirHistory[$e]" = "$HOME/Pictures/";
      "dolphinrc"."General"."ViewPropsTimestamp" = "2024,8,8,21,14,51.86";
      "dolphinrc"."IconsMode"."PreviewSize" = 256;
      "dolphinrc"."KFileDialog Settings"."Places Icons Auto-resize" = false;
      "dolphinrc"."KFileDialog Settings"."Places Icons Static Size" = 22;
      "dolphinrc"."PreviewSettings"."Plugins" = "kraorathumbnail,jpegthumbnail,appimagethumbnail,audiothumbnail,svgthumbnail,windowsimagethumbnail,directorythumbnail,exrthumbnail,ebookthumbnail,opendocumentthumbnail,windowsexethumbnail,imagethumbnail,comicbookthumbnail,djvuthumbnail,cursorthumbnail,fontthumbnail,rawthumbnail,ffmpegthumbs,mobithumbnail,blenderthumbnail,gsthumbnail";
      "dolphinrc"."VersionControl"."enabledPlugins" = "Git";
      "kactivitymanagerdrc"."activities"."4e05a776-1eca-4a3e-97fe-0e848bd4ff1a" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "4e05a776-1eca-4a3e-97fe-0e848bd4ff1a";
      ...
      "kscreenlockerrc"."Greeter/Wallpaper/org.kde.image/General"."Image" = "/home/elias/NyxOS/nix-wallpaper-binary-black_8k.png";
      "kscreenlockerrc"."Greeter/Wallpaper/org.kde.image/General"."PreviewImage" = "/home/elias/NyxOS/nix-wallpaper-binary-black_8k.png";
      ...
      "kwinrc"."Desktops"."Id_1" = "63bbbf1e-350e-4224-aa6f-b0cf5f71d38f";
      ...
      "kwinrc"."Tiling/24eac09a-0311-5a3c-9e9f-3f1576e5ea35"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/8f8ad246-ba88-506f-95ce-79eb63be27b6"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/b80a3564-a82f-5eb3-8081-24e784088631"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/c3c8743a-f895-52b7-a242-636518910af0"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "plasma-localerc"."Formats"."LC_TIME" = "en_AT.UTF-8";
      "plasmanotifyrc"."Applications/thunderbird"."Seen" = true;
      "plasmarc"."Theme"."name" = "default";
      "plasmarc"."Wallpapers"."usersWallpapers" = "/home/elias/NyxOS/nixos-wallpaper-catppuccin-mocha.png";
    };
  };
}
