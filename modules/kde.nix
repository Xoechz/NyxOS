  ...
  flake.modules.homeManager.plasma-manager = { config, ... }: {
    ...
    programs.plasma = {
      ...
      shortcuts = {
        ...
        "kwin"."Walk Through Windows Alternative (Reverse)" = "Shift+Num+Home";
        "kwin"."Walk Through Windows Alternative" = "Shift+Num+End";
        ...
        "kwin"."Window Maximize" = [ "Meta+PgUp" "Num+PgUp" ];
        "kwin"."Window Minimize" = [ "Meta+PgDown" "Num+PgDown" ];
        ...
        "kwin"."Window One Screen Down" = [ "Meta+Shift+Down" "Shift+Num+Down" ];
        "kwin"."Window One Screen Up" = [ "Meta+Shift+Up" "Shift+Num+Up" ];
        "kwin"."Window One Screen to the Left" = [ "Meta+Shift+Left" "Shift+Num+Left" ];
        "kwin"."Window One Screen to the Right" = [ "Meta+Shift+Right" "Shift+Num+Right" ];
        ...
        "kwin"."Window Quick Tile Bottom" = [ "Meta+Down" "Num+Down" ];
        "kwin"."Window Quick Tile Left" = [ "Meta+Left" "Num+Left" ];
        "kwin"."Window Quick Tile Right" = [ "Meta+Right" "Num+Right" ];
        "kwin"."Window Quick Tile Top Left" = [ ];
        "kwin"."Window Quick Tile Top Right" = [ ];
        "kwin"."Window Quick Tile Top" = [ "Meta+Up" "Num+Up" ];
        "kwin"."Window Raise" = [ ];
        "kwin"."Window Resize" = [ ];
        "kwin"."Window Shade" = [ ];
